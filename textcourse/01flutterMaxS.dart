...
///Не стесняйтесь добавлять const где можете, это поможет не перестраивать 
///данные параметры каждый раз и увеличит производительность приложения.
///
...
///Про лямбда функцию(безымянную)
///Остальные функции имеют имена, такие как main() или printElement(). Вы также 
///можете создать безымянную функцию, называемую анонимной функцией, а иногда 
///лямбда-выражение или замыкание.